    ...
    return(
        <div className="relative isolate bg-blue-900 px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div className="mx-auto max-w-4xl text-center">
                ...
                <p className="mt-2 text-5xl font-semibold tracking-tight text-balance text-white sm:text-6xl">Planes</p>
            </div>
            <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil sint iste mollitia architecto ipsam, ad illo fuga, ipsum repellendus incidunt, nesciunt doloribus ullam adipisci labore suscipit. Ex veritatis recusandae quo!</p>
            <div className="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2">
                ...
                <a href="#" aria-describedby="tier-enterprise" className="mt-8 block rounded-md bg-[#3366CC] px-3.5 py-2.5 text-center text-sm font-semibold text-white hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 sm:mt-10">Get started today</a>
                </div>
            </div>
        </div>
